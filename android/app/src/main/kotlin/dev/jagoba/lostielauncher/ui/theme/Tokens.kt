...
object LauncherSizes {
    ...
    val DialogScreenGutter: Dp = 16.dp
    val DialogTitleIcon: Dp = 18.dp
    val DialogCloseIcon: Dp = 12.dp
    val DialogButtonHeight: Dp = 34.dp
    val DialogOkButtonWidth: Dp = 100.dp
    val DialogYesNoButtonWidth: Dp = 90.dp
    val DialogConfirmButtonWidth: Dp = 120.dp
    val DialogCancelButtonWidth: Dp = 100.dp
    val WelcomeContinueButtonWidth: Dp = 160.dp
    val MessageBoxWidth: Dp = 420.dp
    val MessageBoxMinHeight: Dp = 220.dp
    val MessageBoxMaxHeight: Dp = 560.dp
    val DownloadDialogWidth: Dp = 480.dp
    val DownloadDialogHeight: Dp = 420.dp
    val DownloadDialogLogoWidth: Dp = 90.dp
    val DownloadDialogLogoHeight: Dp = 72.dp
    val DownloadDialogLogoPlaceholder: Dp = 28.dp
    val DownloadDialogMetricIcon: Dp = 14.dp
    val DialogLinkIcon: Dp = 11.dp
    val DialogFieldIcon: Dp = 12.dp
    val SpecialVersionDialogWidth: Dp = 440.dp
    val SpecialVersionDialogHeight: Dp = 250.dp
    val WelcomeDialogWidth: Dp = 480.dp
    val WelcomeDialogHeight: Dp = 500.dp
    val WelcomeBrandTile: Dp = 64.dp
    val WelcomeBrandIcon: Dp = 30.dp
    val WelcomeRowIcon: Dp = 16.dp
    val ComboBoxMinWidth: Dp = 160.dp
    val ComboBoxHeight: Dp = 34.dp
